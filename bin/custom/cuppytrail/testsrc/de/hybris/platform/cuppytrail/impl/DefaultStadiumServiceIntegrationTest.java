...
public class DefaultStadiumServiceIntegrationTest extends ServicelayerTransactionalTest {
    ...
    /**
     * This test tests and demonstrates that the Service's getAllStadium method calls the DAOs'
     * getAllStadium method and
    ...
    public void testStadiumService() {
        ...
        assertEquals("Unexpected stadium found", stadiumModel, stadiumModels.get(stadiumModels.size() -
                1));
